...
<html lang="{{ config('app.locale') }}">
    <head>
        ...
        <title>BingHR Take Home Interview</title>
                    ...
                    <div class="js-sidebar-scroll">
                        ...
                        <div class="content-side content-side-full content-side-user px-10 align-parent">
                            ...
                            <div class="sidebar-mini-hidden-b text-center">
                                ...
                                <a href="{{route('logout')}}">
                                <button class="btn btn-danger">Logout here</button>
                                </a>
                        ...
                        <div class="content-side content-side-full">
                            <ul class="nav-main">
                                ...
                                <li>
                                    <a href="/">
                                        <i class="si si-globe"></i><span class="sidebar-mini-hide">Employee</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="/">
                                        <i class="si si-globe"></i><span class="sidebar-mini-hide">Activities</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="/">
                                        <i class="si si-bubble"></i><span class="sidebar-mini-hide">Holiday</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="/">
                                        <i class="si si-event"></i><span class="sidebar-mini-hide">Event</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="/">
                                        <i class="si si-paypal"></i><span class="sidebar-mini-hide">Payroll</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="/">
                                        <i class="si si-briefcase"></i><span class="sidebar-mini-hide">Account</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="/">
                                        <i class="si si-docs"></i><span class="sidebar-mini-hide">Report</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="content-header-section">
                        ...
                        <div class="btn-group" role="group">
                            <button type="button" class="btn btn-rounded btn-dual-secondary" id="page-header-user-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <span class="d-none d-sm-inline-block">Bing Hr</span>
            ...
            <footer id="page-footer">
                <div class="content py-20 font-size-sm clearfix">
                    ...
                    <div class="float-left">
                        <a class="font-w600" href="https://1.envato.market/95j" target="_blank"></a> &copy; <span class="js-year-copy"></span>
                    </div>
                </div>
            </footer>
            <!-- END Footer -->
